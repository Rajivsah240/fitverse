...
const Header = () => {
  return (
    <Stack className="bckg-img" style={{backgroundImage: `url(${backgroundImage})`}}>
      ...
      <Typography
        ...
        //   alignItems: "center",
          ...
          background:
            "linear-gradient(90deg, #F07808 9.23%, rgba(242, 11, 11, 0) 90%)",
      ...
      >
        ...
        <span
          style={{
            background:
              "linear-gradient(90deg, #F07808 3.23%, rgba(242, 11, 11, 0) 150%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            backgroundClip: "text",
